...
def modify_prime_factor(number, prime_id_to_modify, prime_to_modify):
    ...
    if new_number_entry['total_factors'] != 0:
        print(f"Number {new_number} already in the database -> {new_number_entry['total_factors']}.")
        return
    else:
...
# Example usage
for number in range(2000000, 400001, -1):
